<template>
  <section class="pricing py-5">
    <div class="container">
      <p class="h1 text-warning" id="activer-title">veuillez choisir un plan pour activer votre abonnement !</p>
      <div class="row">
        <!-- Standard -->
        <div class="col">
          <div class="card mb-5 mb-lg-0">
            <div class="card-body">
              ...
              <h6 class="card-price text-center">
                20$
                <span class="period">pour 1 an</span>
              </h6>
              <hr>
              <ul class="fa-ul">
              </ul>
        ...
        <div class="col">
          <div class="card mb-5 mb-lg-0">
            <div class="card-body">
              ...
              <h6 class="card-price text-center">
                60$
                <span class="period">pour 4 ans</span>
              </h6>
              <hr>
              <ul class="fa-ul">
              </ul>
